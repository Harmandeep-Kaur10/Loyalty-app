...
<script src="https://cdn.tailwindcss.com/3.4.3" id="cdn_link"></script>
@php($app_data = json_decode($shop->app_data,true))
    ...
    <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-200)">
      ...
      <div style="width:100%;">
        <div class="Polaris-ProgressBar Polaris-ProgressBar--sizeSmall Polaris-ProgressBar--toneHighlight">
         <progress id="progress_bar" class="Polaris-ProgressBar__Progress" value="48" max="100">
         </progress>
         <div id="progress_bar_percent" class="Polaris-ProgressBar__Indicator Polaris-ProgressBar__IndicatorAppearActive" style="--pc-progress-bar-duration:500ms;--pc-progress-bar-percent:0.48">
         </div>
        </div>
      </div>
      <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-200)">
        <h2 class="Polaris-Text--root Polaris-Text--bodyMd">3/6 Steps: Style your loyalty program</h2>
      </div>
...
<!--------------Feature request--------------->
<div class="Polaris-Banner Polaris-Banner--withinPage" style="margin-top:1rem;" tabindex="0" role="status" aria-live="polite">
      ...
      <div class="Polaris-Box" style="--pc-box-color: var(--p-color-text-info-on-bg-fill); --pc-box-background: var(--p-color-bg-fill-info); --pc-box-padding-block-start-xs: var(--p-space-300); --pc-box-padding-block-end-xs: var(--p-space-300); --pc-box-padding-inline-start-xs: var(--p-space-300); --pc-box-padding-inline-end-xs: var(--p-space-300); --pc-box-border-start-start-radius: var(--p-border-radius-300); --pc-box-border-start-end-radius: var(--p-border-radius-300);">
        <div class="Polaris-InlineStack" style="--pc-inline-stack-align:space-between;--pc-inline-stack-block-align:center;--pc-inline-stack-wrap:nowrap;--pc-inline-stack-gap-xs:var(--p-space-200);--pc-inline-stack-flex-direction-xs:row">
          <div class="Polaris-InlineStack" style="--pc-inline-stack-wrap:nowrap;--pc-inline-stack-gap-xs:var(--p-space-100);--pc-inline-stack-flex-direction-xs:row">
            ...
            <h2 class="Polaris-Text--root Polaris-Text--headingSm Polaris-Text--break">Want any other customization?</h2>
          </div>
        </div>
      </div>
        ...
        <div class="Polaris-BlockStack" style="--pc-block-stack-order:column;--pc-block-stack-gap-xs:var(--p-space-200)">
          <div>
            <span class="Polaris-Text--root Polaris-Text--bodyMd">
              <p>Feel free to share any additional customization preferences!</p>
            </span>
          </div>
          <div class="Polaris-ButtonGroup">
            <div class="Polaris-ButtonGroup__Item">
              <button class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantSecondary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter" type="button" onclick="show_feature_request()">
                <span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--medium">Request feature</span>
              </button>
            </div>
          </div>
        </div>
                        ...
                        <div class="Polaris-Modal-Dialog__Modal">
                                <div class="Polaris-Box" style="--pc-box-background: var(--p-color-bg-surface-tertiary); --pc-box-border-color: var(--p-color-border); --pc-box-border-style: solid; --pc-box-border-block-end-width: var(--p-border-width-025); --pc-box-padding-block-start-xs: var(--p-space-400); --pc-box-padding-block-end-xs: var(--p-space-400); --pc-box-padding-inline-start-xs: var(--p-space-400); --pc-box-padding-inline-end-xs: var(--p-space-400);">
                                        <div class="Polaris-InlineGrid" style="--pc-inline-grid-grid-template-columns-xs: 1fr auto; --pc-inline-grid-gap-xs: var(--p-space-400);">
                                                ...
                                                <button onclick="document.getElementById('feature_request').style.display = 'none';" class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantTertiary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter Polaris-Button--iconOnly" aria-label="Close" type="button" aria-pressed="false">
                                                        <span class="Polaris-Icon">
                                                                <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                                        ...
                                        <div class="Polaris-Connected" style="width:94%;">
                                                <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                        <div class="Polaris-TextField Polaris-TextField--hasValue Polaris-TextField--multiline">
                                                                ...
                                                                <textarea autocomplete="off" name="feature_request" class="Polaris-TextField__Input" type="text" rows="4" aria-labelledby=":Rq6:Label" aria-invalid="false" aria-multiline="true" data-1p-ignore="true" data-lpignore="true" data-form-type="other" style="height: 85px;" placeholder="I want to customize...." required=""></textarea>
...
<div class="Polaris-ShadowBevel" style="--pc-shadow-bevel-z-index: 32; --pc-shadow-bevel-content-xs: &quot;&quot;; --pc-shadow-bevel-box-shadow-xs: var(--p-shadow-100); --pc-shadow-bevel-border-radius-xs: var(--p-border-radius-300);width:35%;margin-top:1rem;">
  <div class="Polaris-Box" style="--pc-box-background:var(--p-color-bg-surface);--pc-box-min-height:100%;--pc-box-overflow-x:clip;--pc-box-overflow-y:clip;--pc-box-padding-block-start-xs:var(--p-space-400);--pc-box-padding-block-end-xs:var(--p-space-400);--pc-box-padding-inline-start-xs:var(--p-space-400);--pc-box-padding-inline-end-xs:var(--p-space-400);padding:6% 9% 2% 9%;height:31rem;">
                                        ...
                                        <label style="padding-top:0;" class="Polaris-Choice Polaris-RadioButton__ChoiceLabel" for="disabled">
                                                <span class="Polaris-Choice__Control">
                                                        <span class="Polaris-RadioButton" style="margin-top:0.5vh;">
                                                                <input name="align" style="cursor:pointer;appearance:auto;" type="radio" id="disabled" value="" onclick="left_align()" {{ array_key_exists('align', $data) ? $data['align']=="left" ? 'checked' : '' : '' }}>
                                                        </span>
                                                </span>
                        ...
                        <div class="Polaris-LegacyStack__Item" style="padding-left:3vw;margin-top: 0;">
                                <div>
                                        <label style="padding-top:0;" class="Polaris-Choice Polaris-RadioButton__ChoiceLabel" for="optional">
                                                <span class="Polaris-Choice__Control">
                                                        <span class="Polaris-RadioButton" style="margin-top:0.5vh;">
                                                        <input name="align" style="cursor:pointer;appearance:auto;" type="radio" id="optional" value="" onclick="right_align()" {{ array_key_exists('align', $data) ? $data['align']=="right" ? 'checked' : '' : 'checked' }}>
                                                        </span>
                                                </span>
                                                <span class="Polaris-Choice__Label">
                                                        <span>Right</span>
...
<div style="display:inline-flex;justify-content:space-between;">
       ...
       @else
               style="border:2px solid black;"
       @endif >
               <input type="radio" name="radio" id="icon_and_text" onclick="change_display_type('icon_and_text_radio_button',this.id)" {{ array_key_exists('display_type', $data) ? $data['display_type']=="icon_and_text" ? 'checked' : '' : 'checked' }}/>
...
<!-----------iframe---------------->
<div style="width:65%;">
<h2 style="margin-top:0.5rem;margin-left:37%;font-size:20px;font-weight:bold;cursor:default;">Frontend Preview</h2>

<div id="iframeid" class="Polaris-ShadowBevel" style="font-family:auto;--pc-shadow-bevel-content-xs: &quot;&quot;; --pc-shadow-bevel-box-shadow-xs: var(--p-shadow-100); --pc-shadow-bevel-border-radius-xs: var(--p-border-radius-300);opacity:1;display:flex;position:relative;top:0.5rem;border:none;border-radius:10px;background-color:#f6f6f7;box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);width:21rem;height:25rem;
       @if(array_key_exists('align', $data) && $data['align'] == 'left')
               left:3%;
        @else
               left:49.5%;
...
<!-------------------No claimed rewards--------------------------------->
<div class="hidden max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow your-rewards-tab" style="text-align:center;display:none;">
        <h6 class="font-bold tracking-tight text-gray-900 cursor-default" style="top:-6px;">No claimed rewards</h6>
</div>
...
<!-------------widget-------------------->
<button id="loyaltywidget" type="button" class="elements" onclick="open_iframe()" style="display:flex;font-family:auto;position:absolute;top:48rem;height:48px;border-radius:13px;font-size:1.1em;cursor:pointer;border:none;;
@if(array_key_exists('align', $data))
       @if($data['align'] == 'left' && $data['display_type'] == 'text_only')
               width:7rem;left:37.5%;
       @elseif($data['align'] == 'left' && $data['display_type'] == 'icon_only')
               width:3.3rem;left:37.5%;
       @elseif($data['align'] == 'left' && $data['display_type'] == 'icon_and_text')
               width:8.3rem;left:37.5%;
       @elseif($data['align'] == 'right' && $data['display_type'] == 'text_only')
               width:7rem;left:88%;
       @elseif($data['align'] == 'right' && $data['display_type'] == 'icon_only')
               width:3.3rem;left:93.5%;
       @elseif($data['align'] == 'right' && $data['display_type'] == 'icon_and_text')
               width:8.3rem;left:86%;
       @else
               width:8.3rem;left:86%;
       @endif
@else
       width:8.3rem;left:86%;background-color:slateblue;color:white;
@endif
       ">
...
function move_to_next_step()
{
	...
	form.action = "{{env('APP_URL')}}/api/save_onboarding_step_details/{{$shop->msd}}/3";
	form.submit();
	startLoading();
}
...
function show_feature_request()
{
   	...
   	logActivity('opened feature request popup for customization on onboarding step3','{{$shop->msd}}');
}
...
function change_display_type(element_id,type)
{
	...
	if(type == "icon_and_text")
	{
		...
		if(alignment == "right")
		{
			document.getElementById("loyaltywidget").style.left ="86%";
		}
	}
	if(type == "text_only")
	{
		...
		if(alignment == "right")
		{
			document.getElementById("loyaltywidget").style.left ="88%";
		}
	}
	if(type == "icon_only")
	{
		...
		if(alignment == "right")
		{
			document.getElementById("loyaltywidget").style.left ="93.5%";
		}
	}
}
...
function right_align()
{
	...
	document.getElementById("iframeid").style.left = "49.5%";
	document.getElementById("hiddeninput").value = "right";
}

function left_align()
{
	document.getElementById("loyaltywidget").style.left ="37.5%";
	document.getElementById("iframeid").style.left = "3%";
